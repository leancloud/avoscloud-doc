...
本文介绍了如何在 iOS 设备中使用 LeanCloud 的推送功能。建议先阅读《推送通知服务总览》了解相关概念。
...
然后，调用推送通知服务提供的接口发送推送消息：

![调用推送通知服务接口发推送](images/push-workflow-ios.svg)
...
频道对于大多数应用来说可能就足够了。但是某些情况下，你可能需要更高精度的定向推送。推送通知服务允许你通过 LCQuery API 查询 Installation 列表，并向指定条件的 query 推送消息。
