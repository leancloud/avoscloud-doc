...
```xml
<dependency org="cn.leancloud" name="storage-core" rev="8.0.2" />
```

SBT：

```scala
libraryDependencies += "cn.leancloud" %% "storage-core" % "8.0.2"
```

Gradle：

```groovy
implementation 'cn.leancloud:storage-core:8.0.2'
```
...
```xml
<dependency org="cn.leancloud" name="realtime-core" rev="8.0.2" />
```

SBT:

```scala
libraryDependencies += "cn.leancloud" %% "realtime-core" % "8.0.2"
```
